...
<section class="padding-top30">
                    ...
                    <div class="col-md-9">
                            <div class="cart-table table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th class="text-center"  colspan="2">장난감 반납관리</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="text-left">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="site-btn">
                ...
                <button class="btn btn-1" type="button" onclick="javascript:window.location='./AdminReturnListAction.action'" style="background-color: #87df2d;">                                   
