...
<script type="text/javascript">
	function open_win_noresizable(url, name) {
		var oWin = window
				.open(url, name,
						"scrollbars=qna_no, status=qna_no, resizable=qna_no, width=300, height=150");
	...
	<tr>
		...
		<td align="right">
			<button class="btn" type="button"
				...
				<span class="txt"
					style="color: #fff; font-family: sans-serif; font-weight: bold;">답변달기</span>
				<span class="round" style="background-color: #35beea;"><i
					class="fa fa-chevron-right" style="color: white;"></i></span>
			</button>
			
			<button class="btn" type="button"
				onclick="javascript:open_win_noresizable('qnaCheckForm.action?qna_no=<s:property value="resultClass.qna_no" />&currentPage=<s:property value="currentPage" />','modify')"
				class="btn_small3" style="background-color: #87df2d;">
				<span class="txt"
			...
			<button class="btn" type="button"
				onclick="javascript:open_win_noresizable('qnaCheckForm.action?qna_no=<s:property value="resultClass.qna_no" />&currentPage=<s:property value="currentPage" />','delete')"
				class="btn_small3" style="background-color: #87df2d;">
				<span class="txt"
