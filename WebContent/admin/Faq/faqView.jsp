							...
							<tr>
								<td colspan="2" align="right">
									...
									<div class="site-btn" style="margin-left: 600px;">
						                <button class="btn btn-1" type="button" onclick="javascript:location.href='faqModifyForm.action?faq_no=<s:property value="resultClass.faq_no"/>&currentPage=<s:property value="currentPage"/>'"/>                                 
						                ...
						                <button class="btn btn-1" type="button" onclick="javascript:location.href='faqDeleteAction.action?faq_no=<s:property value="resultClass.faq_no"/>&currentPage=<s:property value="currentPage"/>'"/>                               
