...
import board.Event.eventPagingAction;
...
public class eventListAction extends ActionSupport
{
	...
	public eventListAction() throws Exception
	{
	...
	public String search() throws Exception {
		...
		if(searchNum == 0){
			list = sqlMapper.queryForList("Event-selectSearchS", "%"+getSearchKeyword()+"%");
		}
		if(searchNum == 1){
			list = sqlMapper.queryForList("Event-selectSearchC", "%"+getSearchKeyword()+"%");	
		}
	...
	public static void setSqlMapper(SqlMapClient sqlMapper) {
		eventListAction.sqlMapper = sqlMapper;
	}
