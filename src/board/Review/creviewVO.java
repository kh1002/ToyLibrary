...
public class creviewVO {
	...
	public Date getCreview_regdate() {
		return creview_regdate;
	}
	public void setCreview_regdate(Date creview_regdate) {
		this.creview_regdate = creview_regdate;
	}
